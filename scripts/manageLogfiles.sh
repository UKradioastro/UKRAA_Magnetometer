...
if [ -r log-Magnetometer-1.txt ]; then
    ...
    su pi -c "mv -f log-Magnetometer-1.txt log-Magnetometer-2.txt"
fi
...
if [ -r log-Magnetometer-0.txt ]; then
    ...
    su pi -c "mv -f log-Magnetometer-0.txt log-Magnetometer-1.txt"
fi
...
if [ -r log-Magnetometer.txt ]; then
    ...
    su pi -c "mv -f log-Magnetometer.txt log-Magnetometer-0.txt"
fi
...
chown pi:pi log-Magnetometer.txt log-error.txt dashboard-summary.log
