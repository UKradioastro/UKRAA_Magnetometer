...
su pi -c "/usr/bin/gnuplot /home/pi/UKRAA_Magnetometer/scripts/PlotDataXYZ.gp \
                        >> /home/pi/UKRAA_Magnetometer/logfiles/log-Magnetometer.txt \
                       2>> /home/pi/UKRAA_Magnetometer/logfiles/log-error.txt"

# cron entry to plot yesterdays counts per minute frequency
su pi -c "/usr/bin/gnuplot /home/pi/UKRAA_Magnetometer/scripts/PlotDataActivity.gp \
                        >> /home/pi/UKRAA_Magnetometer/logfiles/log-Magnetometer.txt \
                       2>> /home/pi/UKRAA_Magnetometer/logfiles/log-error.txt"
