...
if (is_missing == 1) {
    print system("date +'%Y-%m-%d %H:%M:%S'") \
          ." : ".sprintf("%-27s", "PlotDataXYZ.gp")." : FAILED - data file missing"
    exit
}
...
if (dirCreated == 1) {
    print system("date +'%Y-%m-%d %H:%M:%S'") \
          ." : ".sprintf("%-27s", "PlotDataXYZ.gp")." : New directory created : ".plotMonthDir
}
...
print system("date +'%Y-%m-%d %H:%M:%S'") \
      ." : ".sprintf("%-27s", "PlotDataXYZ.gp")." : Started XYZ plot for " \
      .dateTag
...
unset xlabel
set yrange [XSTAT_min - 10:XSTAT_max + 10]
...
set ytics textcolor rgb magneticColor
unset xlabel
set yrange [YSTAT_min - 10:YSTAT_max + 10]
set y2label "Temperature (°C)"
set y2label textcolor rgb tempColor
set y2tics textcolor rgb tempColor
set y2range [tempRangeMin:tempRangeMax]
...
print system("date +'%Y-%m-%d %H:%M:%S'") \
      ." : ".sprintf("%-27s", "PlotDataXYZ.gp")." : Completed XYZ plot for " \
      .dateTag
