...
is_missing = system("/home/pi/UKRAA_muons/scripts/ismissing.sh ".FileData)
if (is_missing == 1) {print "PlotDataBIACM0.gp     : ".system("date +'%Y/%M/%d %H:%M:%S'")." : B & I data file missing, so..."; 
    print "PlotDataBIACM0.gp     : "\
        .system("date +'%Y/%M/%d %H:%M:%S'")\
        ." : **FAILED** to complete B & I plots for "\
        .system("date -d yesterday +'%Y-%m-%d'")
    exit
}
...
stats FileData using 14 output prefix "B-field" nooutput
stats FileData using 15 output prefix "I-field" nooutput
...
pathTempPlot1 = "/home/pi/UKRAA_Magnetometer/temp/B"
pathTempPlot2 = "/home/pi/UKRAA_Magnetometer/temp/I"
...
set yrange [ (((B-field_min/B-field_mean)*100)-100)-5 : (((B-field_max/B-field_mean)*100)-100)+5 ] noreverse nowriteback
