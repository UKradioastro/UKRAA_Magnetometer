...
archivePlot = basePath."/plots/rolling/RollingBI.png"
tempPlot = basePath."/temp/rolling/RollingBI.png"
...
stats rollingData using 13 output prefix "BSTAT" nooutput
stats rollingData using 14 output prefix "ISTAT" nooutput
...
plotTitle = sprintf("Rolling BI magnetic field for the last 24 hours\nUpdated every 5 minutes\n%s UTC to %s UTC", startX, endX)
...
plot rollingData using 1:13 with lines linewidth 1.2 linecolor rgb magneticColor notitle, \
...
set label 14 sprintf("Min Temp(C) : %0.1f °C", TSTAT_min)
set label 14 at graph tempStatX, statMinY tc rgb tempColor
plot rollingData using 1:14 with lines linewidth 1.2 linecolor rgb magneticColor notitle, \
    rollingData using 1:8 axes x1y2 with lines linewidth 1.0 linecolor rgb tempColor notitle
