...
stats rollingData using 10 output prefix "HSTAT" nooutput
stats rollingData using 11 output prefix "DSTAT" nooutput
stats rollingData using 12 output prefix "ZSTAT" nooutput
...
plotTitle = sprintf("Rolling HDZ magnetic field for the last 24 hours\nUpdated every 5 minutes\n%s UTC to %s UTC", startX, endX)
...
plot rollingData using 1:10 with lines linewidth 1.2 linecolor rgb magneticColor notitle, \
...
set label 14 sprintf("Min Temp(C) : %0.1f °C", TSTAT_min)
set label 14 at graph tempStatX, statMinY tc rgb tempColor
plot rollingData using 1:11 with lines linewidth 1.2 linecolor rgb magneticColor notitle, \
    rollingData using 1:8 axes x1y2 with lines linewidth 1.0 linecolor rgb tempColor notitle
...
set label 14 sprintf("Min Temp(C) : %0.1f °C", TSTAT_min)
set label 14 at graph tempStatX, statMinY tc rgb tempColor
plot rollingData using 1:12 with lines linewidth 1.2 linecolor rgb magneticColor notitle, \
    rollingData using 1:8 axes x1y2 with lines linewidth 1.0 linecolor rgb tempColor notitle
